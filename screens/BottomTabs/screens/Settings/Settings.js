...
import { StyleSheet, ScrollView, View, Text, Image, TouchableOpacity, Modal, Switch, Alert } from 'react-native'
...
function Settings({ navigation }) {
            ...
            TouchID.isSupported()
                .then(supported => {
                    ...
                    if (supported) {
                        ...
                        Alert.alert('Face ID is not supported or not enrolled on this device.');
                        setModalVisible(!modalVisible)
                    }
                })
                .catch(error => {
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', width: '90%', marginLeft: '5%', justifyContent: 'space-around', marginTop: '5%' }}>
                <Text style={{ marginLeft: 10, fontSize: 16, color: '#686868' }}>Use Fingerprint/FaceId/PIN to log in</Text>
                <Switch
                    value={isSwitchOn}
