...
export default function Notifications({navigation}) {
  ...
  async function GetNotifications() {
    ...
    axios
      .get(BasePath + 'listOfNotifications', {
        headers: {
...
const data = [
  {
    title: 'Bag Request',
    message:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi rhoncus felis non ullamcorper porta. Pellentesque id est in urna porttitor commodo. Fusce dictum lacus massa, et lobortis massa dapibus sed. ',
    key: 'item1',
    status: 0,
  },
  {
    title: 'Deposit Alert ,Nov 13',
    message:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi rhoncus felis non ullamcorper porta.Vivamus vitae finibus massa. ',
    key: 'item1',
    status: 1,
  },
  {
    title: 'Deposit Alert , Nov 15',
    message:
      ' Pellentesque id est in urna porttitor commodo. Fusce dictum lacus massa, et lobortis massa dapibus sed. Sed bibendum sit amet erat eu suscipit. Interdum et malesuada fames ac ante ipsum primis in faucibus. Vivamus vitae finibus massa. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi rhoncus felis non ullamcorper porta.',
    key: 'item1',
    status: 1,
  },
];
