...
export default function DepositBag({ navigation, route }) {
    ...
    const [textInputs, setTextInputs] = useState({
        ...
        input4: { name: 'X5', value: '', amount: 5 },
        input5: { name: 'Coins '+currencyArray[1]+1, value: '', amount: 1 },
        input6: { name: 'Coins', value: '', amount: 1 },
    });
    ...
    return (
        <View style={styles.loginContainer}>
            <KeyboardAwareScrollView style={{ flex: 1 }}>
                ...
                <HandleMoneyInput onChangeText={text => handleCurrency('input2', text)} name={textInputs.input2.name} />
                <HandleMoneyInput onChangeText={text => handleCurrency('input3', text)} name={textInputs.input3.name} />
                <HandleMoneyInput onChangeText={text => handleCurrency('input4', text)} name={textInputs.input4.name} />
                <HandleMoneyInput onChangeText={text => handleCurrency('input5', text)} name={textInputs.input5.name} />
                <HandleMoneyInput onChangeText={text => handleCurrency('input6', text)} name={textInputs.input6.name} />
